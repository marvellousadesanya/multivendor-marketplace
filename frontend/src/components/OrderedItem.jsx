...
const OrderedItem = ({ title, productImg, price }) => {
  return (
    <div className="w-[821px] bg-[#fff] rounded-2xl flex h-[231px]  justify-between p-7 text-xs text-bodyColor">
      <div>
      ...
      <div className="space-y-5">
        ...
        <div className="flex space-x-3 font-bold font-innerbody">
          ...
          <button className="bg-mainColor rounded-xl py-2 px-4 text-[#fff]">
            Confirm delivery
          </button>
        </div>
      </div>
